# Test script: Run Debug build with MW05_UNBLOCK_MAIN for 2 minutes
...
Write-Host "Starting DEBUG game with MW05_UNBLOCK_MAIN=1 for 120 seconds..." -ForegroundColor Green

$proc = Start-Process -FilePath ".\out\build\x64-Clang-Debug\Mw05Recomp\Mw05Recomp.exe" -PassThru

Write-Host "Waiting 120 seconds..." -ForegroundColor Cyan
...
Write-Host "`nAnalyzing Debug trace log..." -ForegroundColor Cyan
...
Select-String -Path $logPath -Pattern "tid=.*lr=0x82441" | Select-Object -Last 20
