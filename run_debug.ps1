...
$env:MW05_VD_E68_HANDSHAKE=1;
$env:MW05_VD_READ_TRACE=1;
$env:MW05_AUTO_VDSWAP_HEUR=0;
$env:MW05_AUTO_VDSWAP_HEUR_DELAY=24;
$env:MW05_AUTO_VDSWAP_HEUR_ONCE=1;
$env:MW05_AUTO_VDSWAP_HEUR_E58_MASK='0x700';
$env:MW05_AUTO_VDSWAP_HEUR_E68_MASK='0x2';
$env:MW05_VD_E58_MIRROR_E60_HI=1;
$env:MW05_VD_E58_LOW16_FORCE='0x300';
$env:MW05_VD_E68_ACK_PULSE=1;
$env:MW05_VD_TOKEN_ON_FLIP=1;
$env:MW05_VD_E48_LOW16_FORCE='0x0';
$env:MW05_FORCE_VDSWAP_ONCE=1;
$env:MW05_TREAT_PRESENT_AS_VDSWAP=1;
Remove-Item Env:\MW05_VD_POKE_E58,Env:\MW05_VD_POKE_E70 `
  -ErrorAction Ignore
.\Mw05Recomp.exe
