...
CONFIG_DEFINE_ENUM_TEMPLATE(SDL_Scancode)
{
    ...
    /* SDL3 removed generic aliases for WWW/MAIL/CALCULATOR/COMPUTER */
    ...
    /* Brightness/Display scancodes may not exist on all SDL3 builds; comment out if undefined */
    /* { "BRIGHTNESS DOWN", SDL_SCANCODE_BRIGHTNESS_DOWN }, */
    /* { "BRIGHTNESS UP", SDL_SCANCODE_BRIGHTNESS_UP }, */
    /* { "DISPLAY SWITCH", SDL_SCANCODE_DISPLAY_SWITCH }, */
    // Keyboard illumination scancodes may not be defined in this SDL3 build; omit
    // { "KBD ILLUM TOGGLE", SDL_SCANCODE_KBD_ILLUM_TOGGLE },
    // { "KBD ILLUM DOWN", SDL_SCANCODE_KBD_ILLUM_DOWN },
    // { "KBD ILLUM UP", SDL_SCANCODE_KBD_ILLUM_UP },
    { "EJECT", SDL_SCANCODE_MEDIA_EJECT },
    { "SLEEP", SDL_SCANCODE_SLEEP },
    /* APP1/APP2 not present in SDL3 */
